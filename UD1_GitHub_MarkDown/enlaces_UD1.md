...
- U1_E3 Evaluación comparativa de generadores de documentación → **pendiente**  
...
- U1_E5 Seguridad y accesibilidad en Control de Versiones → **pendiente**  
  ...
  - Configuración de accesibilidad / permisos en GitHub (colaboradores / roles).  
  - Creación de `SECURITY.md` explicando buenas prácticas, protección de repositorio y recuperación ante fallos.
